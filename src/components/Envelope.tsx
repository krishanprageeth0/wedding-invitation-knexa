...
export default function Envelope({ onOpen }: EnvelopeProps) {
  ...
  const handleOpen = () => {
    ...
    setTimeout(() => {
      ...
      const colors = ["#b87d6c", "#c9a96e", "#e8c87a", "#8a8070", "#ffffff"];
        ...
        >
          ...
          <div className="relative z-10 flex flex-col items-center text-center max-w-sm mb-8 mt-12">
            <motion.p
              ...
              className="text-[#f0ebe0]/75 font-oranienbaum tracking-[0.32em] text-[10px] uppercase mb-4"
            >
            ...
            <motion.h1
              ...
              className="text-[#f0ebe0] text-5xl md:text-6xl font-mea font-normal leading-[0.85] my-0"
            >
              Chammi
            </motion.h1>
            ...
            >
              <defs>
                ...
                <linearGradient id="flapFill" x1="0" y1="0" x2="0" y2="1">
                  <stop offset="0%" stopColor="#251d1a" />
              ...
              >
                ...
                <text x="149" y="106" textAnchor="middle" fontSize="11" fill="rgba(40,18,0,0.9)" fontFamily="var(--font-cinzel), serif" letterSpacing="0.05em" fontWeight="bold">
                  C&D
                </text>
              </motion.g>
            </svg>
          ...
          >
            <p className="text-gold tracking-[0.32em] text-[10px] uppercase font-semibold font-oranienbaum">
