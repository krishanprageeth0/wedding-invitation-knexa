...
export default function Countdown() {
  const targetDate = new Date("2026-07-20T09:30:00").getTime();
  ...
  return (
    <section id="countdown" className="relative py-28 px-4 bg-[#0d0d0d] text-[#fdfbf7] overflow-hidden bg-sparkles flex flex-col items-center">
      ...
      <div className="max-w-xl w-full mx-auto text-center relative z-10 flex flex-col items-center pt-6">
            ...
            <React.Fragment key={item.label}>
              ...
              >
                ...
                <div className="glass w-full py-4 md:py-6 rounded-xl border border-gold/15 hover:border-gold/35 transition-colors duration-500 shadow-xl flex items-center justify-center relative overflow-hidden group">
                  ...
                  <span className="font-oranienbaum text-3xl sm:text-4xl md:text-5xl text-[#fdfbf7] font-medium leading-none tracking-wide tabular-nums">
              ...
              {idx < countdownItems.length - 1 && (
                <span className="text-gold font-oranienbaum text-2xl sm:text-3xl leading-none -mt-6 select-none opacity-45">
                  :
                </span>
              )}
            </React.Fragment>
        ...
        <motion.div
          ...
          className="mt-16 text-[#fdfbf7]/60 text-xs tracking-[0.25em] font-cormorant uppercase font-medium border-t border-gold/10 pt-4 px-6"
        >
          MONDAY, JULY 20, 2026 • 09:30 AM
        </motion.div>
      </div>
    </section>
  );
