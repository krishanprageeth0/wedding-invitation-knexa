...
export default function Hero() {
  return (
    <section className="relative min-h-screen flex flex-col justify-center items-center py-24 px-6 text-center overflow-hidden bg-[#0d0d0d] select-none">
      ...
      <div className="absolute inset-0 z-0 pointer-events-none">
        <div 
          className="absolute inset-0 bg-cover bg-center opacity-[0.16] filter brightness-[0.2] blur-[4px]" 
          style={{ backgroundImage: "url('/couple.jpg')" }}
        />
        {/* Radial dark shadow vignette */}
        <div className="absolute inset-0 bg-[radial-gradient(ellipse_at_center,transparent_10%,rgba(13,13,13,0.95)_80%)]" />
        <div className="absolute inset-x-0 bottom-0 h-48 bg-gradient-to-t from-[#0d0d0d] to-transparent" />
      </div>
      ...
      <div className="max-w-md mx-auto flex flex-col items-center relative z-20 w-full pt-6">
        ...
        <motion.p
          ...
          className="text-gold font-oranienbaum tracking-[0.32em] text-[10px] md:text-xs uppercase font-medium mb-5"
        >
        ...
        <div className="flex flex-col items-center w-full mb-6">
          <motion.h1
            ...
            className="text-[#f0ebe0] text-7xl md:text-8xl font-mea font-normal leading-[0.8] my-0 drop-shadow-[0_4px_12px_rgba(0,0,0,0.5)]"
          >
            Chammi
          </motion.h1>
        ...
        <motion.p
          ...
          className="text-[#f0ebe0] tracking-[0.28em] text-[9px] uppercase font-semibold font-oranienbaum mt-6 mb-4"
        >
        ...
        <div className="w-full max-w-[280px] my-3">
          <motion.p
            ...
            className="text-gold tracking-[0.55em] text-[10px] font-semibold uppercase font-oranienbaum mb-2"
          >
            JULY
          </motion.p>
          ...
          <div className="flex items-center justify-between py-3 px-1">
            <motion.span
              ...
              className="text-[#f0ebe0] tracking-[0.22em] text-[9px] uppercase font-bold font-oranienbaum w-1/3 text-right pr-2"
            >
              Monday
            </motion.span>
            ...
            <motion.span
              ...
              className="text-[#f0ebe0] text-4xl md:text-5xl font-cinzel leading-none w-1/3 text-center drop-shadow-[0_2px_4px_rgba(0,0,0,0.3)]"
            >
              20
            </motion.span>
            ...
            <motion.span
              ...
              className="text-[#f0ebe0] tracking-[0.22em] text-[9px] uppercase font-bold font-oranienbaum w-1/3 text-left pl-2"
            >
              At 9:30 AM
            </motion.span>
          </div>
          ...
          <motion.p
            ...
            className="text-gold tracking-[0.55em] text-[10px] font-semibold uppercase font-oranienbaum mt-2"
          >
            2026
          </motion.p>
        </div>
        ...
        <motion.p
          ...
          className="text-[#f0ebe0] tracking-[0.18em] text-[10px] uppercase font-semibold font-oranienbaum leading-relaxed mt-6"
        >
          Summerfield’s Banquet Hall<br />
          Colombo, Sri Lanka
        </motion.p>
      </div>
    </section>
